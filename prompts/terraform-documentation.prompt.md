Act as an expert in Terraform, Microsoft Azure architecture, and Mermaid diagrams.
...
- Main Azure components grouped by networking, compute, storage, security, identity, and monitoring.
